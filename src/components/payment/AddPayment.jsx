          ...
          <div className="flex flex-col lg:w-1/3 sm:w-2/5 w-full border border-border-color h-screen p-5 gap-y-5">
            <div className="flex flex-col w-full items-start gap-y-5">
              ...
              <div className="flex flex-col items-start gap-y-2 w-full">
                ...
                <input
                  className=" text-sm border-0 border-b border-light-gray w-full focus:outline-none focus:border-bg-blue"
                  placeholder="reason"
          ...
          <div className="  w-full flex flex-col gap-y-3">
            ...
            <div className="flex w-full gap-x-10">
              <div className="w-1/3  flex items-start flex-col gap-y-2">
                ...
                <input
                  className=" text-sm md:text-base border-0 border-b border-light-gray w-full focus:outline-none focus:border-bg-blue"
                  placeholder="Amount"
                  style={{ paddingBottom: "10px" }}
                />
              </div>
